...
def search_algo():
    ...
    if request.method == "POST":
        ...
        try:
            ...
            return render_template("search_algorithm.html", result=result, search_type=search_type, execution_time=execution_time,test_data=test_data)
        except ValueError:
            return render_template("search_algorithm.html", error="Invalid input. Ensure the array and target are integers.")
    

    return render_template("search_algorithm.html",test_data=test_data)
